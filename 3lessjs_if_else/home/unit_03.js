...
function f7() {
   const num1 = document.querySelector('.i-71').value;
   const num2 = document.querySelector('.i-72').value;
...
function f8() {
   const num = +document.querySelector('.s-8').value;
...
function f10() {
   const num = document.querySelector('.s-100').value;
...
function f11() {
   const num = document.querySelector('.s-110').value;
...
function f13() {
   const num = document.querySelector('.i-130').value;
   //input type number запрещает вводить строки, но он не преобразует value в число
...
function f14() {
   ...
   const mult = document.querySelector('.s-143').value;
...
function f15() {
   const num1 = +document.querySelector('.s-151').value;
   const num2 = +document.querySelector('.s-152').value;
   const mult = document.querySelector('.s-153').value;
