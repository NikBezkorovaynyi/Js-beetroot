...
b8.onclick = () => {
    document.querySelector('.out-8').textContent = i8.value;
}
...
b10.onclick = () => {
    document.querySelector('.out-10').textContent = i10.value * 20;
}
...
b11.onclick = () => {
    document.querySelector('.out-11').textContent = +i11.value +55;
}
...
b12.onclick = () => {
    ...
    document.querySelector('.out-12').textContent = ('Hello' + ' ' + res);
}
